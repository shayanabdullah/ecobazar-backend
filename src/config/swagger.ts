    ...
    tags: [
      {
        name: "Authentication",
        description:
          "Account creation and access control: registration, login, email verification, and password reset.",
      },
      {
        name: "User",
      ...
      },
      {
        name: "Admin",
        description:
          "Store-operator endpoints for managing users and platform-wide data. Requires an admin-privileged token.",
      },
    ],
