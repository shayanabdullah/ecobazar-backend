...
// temporary
const categoryUserController = async (req, res) => {
    try {
        ...
        await sendEmailToAdminForCreateCategory(process.env.ADMIN_EMAIL, "EcoBazar Admin", category._id.toString(), category.categoryName.toLowerCase());
